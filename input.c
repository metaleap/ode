...
#define ·__ (OdeHotKey)
    ...
    ·_(k, (·__ {.title = str("tab"),
                .reserved = true,
                .key = ode_key_tab,
                .esc_seq = str("\x09")}));
    ·_(k, (·__ {.title = str("enter"),
                .reserved = true,
                .key = ode_key_enter,
                .esc_seq = str("\x0d")}));
    ·_(k,
       (·__ {.title = str("backspace"), .key = ode_key_back, .esc_seq = str("\x7f")}));
    ·_(k,
       (·__ {.title = str("f1"), .key = ode_key_f1, .esc_seq = str("\x1b\x4f\x50")}));
    ·_(k,
       (·__ {.title = str("f2"), .key = ode_key_f2, .esc_seq = str("\x1b\x4f\x51")}));
    ·_(k,
       (·__ {.title = str("f3"), .key = ode_key_f3, .esc_seq = str("\x1b\x4f\x52")}));
    ·_(k,
       (·__ {.title = str("f4"), .key = ode_key_f4, .esc_seq = str("\x1b\x4f\x53")}));
    ·_(k, (·__ {.title = str("f5"),
                .key = ode_key_f5,
                .esc_seq = str("\x1b\x5b\x31\x35\x7e")}));
    ·_(k, (·__ {.title = str("f6"),
                .key = ode_key_f6,
                .esc_seq = str("\x1b\x5b\x31\x37\x7e")}));
    ·_(k, (·__ {.title = str("f7"),
                .key = ode_key_f7,
                .esc_seq = str("\x1b\x5b\x31\x38\x7e")}));
    ·_(k, (·__ {.title = str("f8"),
                .key = ode_key_f8,
                .esc_seq = str("\x1b\x5b\x31\x39\x7e")}));
    ·_(k, (·__ {.title = str("f9"),
                .key = ode_key_f9,
                .esc_seq = str("\x1b\x5b\x32\x30\x7e")}));
    ·_(k, (·__ {.title = str("f10"),
                .key = ode_key_f10,
                .esc_seq = str("\x1b\x5b\x32\x31\x7e")}));
    ·_(k, (·__ {.title = str("f11"),
                .key = ode_key_f11,
                .esc_seq = str("\x1b\x5b\x32\x33\x7e")}));
    ·_(k, (·__ {.title = str("f12"),
                .key = ode_key_f12,
                .esc_seq = str("\x1b\x5b\x32\x34\x7e")}));
    ·_(k, (·__ {.title = str("left"),
                .key = ode_key_arr_l,
                .esc_seq = str("\x1b\x5b\x44")}));
    ·_(k, (·__ {.title = str("down"),
                .key = ode_key_arr_d,
                .esc_seq = str("\x1b\x5b\x42")}));
    ·_(k,
       (·__ {
           .title = str("up"), .key = ode_key_arr_u, .esc_seq = str("\x1b\x5b\x41")}));
    ·_(k, (·__ {.title = str("right"),
                .key = ode_key_arr_r,
                .esc_seq = str("\x1b\x5b\x43")}));
    ·_(k,
       (·__ {.title = str("end"), .key = ode_key_end, .esc_seq = str("\x1b\x5b\x46")}));
    ·_(k,
       (·__ {
           .title = str("home"), .key = ode_key_home, .esc_seq = str("\x1b\x5b\x48")}));
    ·_(k, (·__ {.title = str("insert"),
                .key = ode_key_ins,
                .esc_seq = str("\x1b\x5b\x32\x7e")}));
    ·_(k, (·__ {.title = str("delete"),
                .key = ode_key_del,
                .esc_seq = str("\x1b\x5b\x33\x7e")}));
    ·_(k, (·__ {.title = str("pageup"),
                .key = ode_key_pgup,
                .esc_seq = str("\x1b\x5b\x35\x7e")}));
    ·_(k, (·__ {.title = str("pagedown"),
                .key = ode_key_pgdn,
                .esc_seq = str("\x1b\x5b\x36\x7e")}));
    ...
    static CStr titles[] = {"shift+",      "alt+",      "alt+shift+",     "ctrl+",
    ...
    ·forEach(OdeHotKey, hk, k, {
        ...
        Bool const is_foo =
            (ode_key_f1 == key || ode_key_f2 == key || ode_key_f3 == key
             || ode_key_f4 == key || ode_key_end == key || ode_key_home == key
             || ode_key_arr_d == key || ode_key_arr_l == key || ode_key_arr_r == key
             || ode_key_arr_u == key);
        Bool const is_baz = (ode_key_pgup == key || ode_key_pgdn == key
                             || ode_key_del == key || ode_key_ins == key);
        Bool const is_bar =
            (is_baz || ode_key_f5 == key || ode_key_f6 == key || ode_key_f7 == key
             || ode_key_f8 == key || ode_key_f9 == key || ode_key_f10 == key
             || ode_key_f11 == key || ode_key_f12 == key);
        if (is_foo || is_bar) {
            Str const pref = is_foo ? str("\x1b\x5b\x31\x3b")
                                    : str2(NULL, strSub(hk->esc_seq, 0, is_baz ? 3 : 4),
                                           str("\x3b"));
            Str const suff =
                is_foo ? strSub(hk->esc_seq, hk->esc_seq.len - 1, hk->esc_seq.len)
                       : str("\x7e");
    ...
    { // now reorder such that all \x1b-prefixed hotkeys follow all non-\x1b ones. at
      // runtime lets us short-circuit the search per keypress
...
Bool odeProcessInput() {
    ...
    static MemHeap bracketed_paste =
        (MemHeap) {.cap = (4 * 1024), .kind = mem_heap_pages_malloc};
    static U8 last7[7];
...
#define ·isEsc(¹the_str__, ²the_len__, ¹the_min_len__)                                 \
    (((i + (¹the_min_len__)) <= ((UInt)n_bytes_read))                                  \
     && strEq((¹the_str__), strL(&buf[i], (²the_len__)), (²the_len__)))
    if (n_bytes_read > 0) {
        for (UInt i = 0, max = (UInt)n_bytes_read; i < max; i += 1) {
            ...
            if (bracketed_paste.ptr != NULL) {
                ...
                U8 const m = buf[i + 3];
                Bool const m_scroll_up = (m == 0x61) || (m == 0x71) || (m == 0x69)
                                         || (m == 0x65) || (m == 0x75) || (m == 0x79)
                                         || (m == 0x6d) || (m == 0x7d);
                Bool const m_scroll_down = (m == 0x60) || (m == 0x70) || (m == 0x68)
                                           || (m == 0x64) || (m == 0x74) || (m == 0x78)
                                           || (m == 0x6c) || (m == 0x7c);
                // Bool const m_any_up = // not currently needed
                //     (m == 0x23) || (m == 0x33) || (m == 0x2b) || (m == 0x27) || (m ==
                //     0x37) || (m == 0x3b) || (m == 0x2f) || (m == 0x3f);
                // Bool const m_any_move = // not currently needed
                //     (m == 0x43) || (m == 0x53) || (m == 0x4b) || (m == 0x47) || (m ==
                //     0x57) || (m == 0x5b) || (m == 0x4f) || (m == 0x5f);
                Bool const m_down_l = (m == 0x20) || (m == 0x30) || (m == 0x28)
                                      || (m == 0x24) || (m == 0x34) || (m == 0x38)
                                      || (m == 0x2c) || (m == 0x3c);
                Bool const m_drag_l = (m == 0x40) || (m == 0x50) || (m == 0x48)
                                      || (m == 0x44) || (m == 0x54) || (m == 0x58)
                                      || (m == 0x4c) || (m == 0x5c);
                Bool const m_down_m = (m == 0x21) || (m == 0x31) || (m == 0x29)
                                      || (m == 0x25) || (m == 0x35) || (m == 0x39)
                                      || (m == 0x2d) || (m == 0x3d);
                Bool const m_drag_m = (m == 0x41) || (m == 0x51) || (m == 0x49)
                                      || (m == 0x45) || (m == 0x55) || (m == 0x59)
                                      || (m == 0x4d) || (m == 0x5d);
                Bool const m_down_r = (m == 0x22) || (m == 0x32) || (m == 0x2a)
                                      || (m == 0x26) || (m == 0x36) || (m == 0x3a)
                                      || (m == 0x2e) || (m == 0x3e);
                Bool const m_drag_r = (m == 0x42) || (m == 0x52) || (m == 0x4a)
                                      || (m == 0x46) || (m == 0x56) || (m == 0x5a)
                                      || (m == 0x4e) || (m == 0x5e);
                ...
                OdeInput evt = (OdeInput) {
                    ...
                    .of = {.mouse = {.scroll = m_scroll_down || m_scroll_up,
                                     .down = m_scroll_down || m_down_l || m_down_m
                                             || m_down_r,
                                     ...
                                     .did_click =
                                         m_pos_eq
                                         && (old.btn_down.left || old.btn_down.mid
                                             || old.btn_down.right)
